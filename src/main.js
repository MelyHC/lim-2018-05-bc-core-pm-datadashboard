              ...
              if (myUsers[i].role === "student") {
                ...
                if (myProgress.hasOwnProperty(myUsers[i].id)) {
                  ...
                  if (progressUser.hasOwnProperty('intro')) {
                    ...
                    const sumScore = unitIntroduction.parts['04-quiz'].score + unitVariables.parts['05-quiz'].score + unitUx.parts['03-quiz'].score;
                    if (intro.hasOwnProperty('percent')) {
                      ...
                      output += '<td>' + parseInt(sumScore/ 3) + '</td>' 
